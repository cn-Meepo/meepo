      ...
      <div class="modal-body">
		<form class="form-horizontal">
		  <div class="form-group">
		    <label for="empName_input" class="col-sm-2 control-label">Name</label>
		    <div class="col-sm-10">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		     	<input type="text" name="email" class="form-control" id="email_update_input" placeholder="email@meepo.com">
		  ...
		  <div class="form-group">
		    <label for="email_add_input" class="col-sm-2 control-label">detpName</label>
		    <div class="col-sm-3">
		      <!-- 部门提交部门id即可 -->
  ...
  <div class="modal-dialog" role="document">
      ...
      <div class="modal-body">
		<form class="form-horizontal">
		  <div class="form-group">
		    <label for="empName_input" class="col-sm-2 control-label">Name</label>
		    <div class="col-sm-10">
		     	<input type="text" name="name" class="form-control" id="empName_add_input" placeholder="Name">
		    	<span class="help-block"></span>
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="email_add_input" class="col-sm-2 control-label">email</label>
		    <div class="col-sm-10">
		     	<input type="text" name="email" class="form-control" id="email_add_input" placeholder="email@meepo.com">
				<span class="help-block"></span>		   
			</div>
		  </div>
		  <div class="form-group">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-4 col-md-offset-8">
				...
				<!-- <input id="input_name" placeholder="请输入一个名字"/>
				<button type="button" class="btn btn-danger" id="test">测试</button> -->
			</div>
		</div>
		<!-- 显示表格数据 -->
		<div class="row">
	...
	//页面加载完成以后，直接去发送一个ajax请求，要到分页数据
		...
		function to_page(pn){
			$.ajax({
				...
				success : function(result) {
					console.log(result);
					//1、解析并显示员工数据
					bulid_emps_table(result.extend.pageInfo.list);
					//2、解析并显示分页信息
					bulid_page_info(result.extend.pageInfo);
					//3、解析显示分页条数据
		...
		function build_page_nav(result) {
			...
			//遍历给ul添加页码提示
			$.each(result.navigatepageNums,function(inde,item){
			...
			var bavEle =$("<nav></nav>").append(ul);
			bavEle.appendTo("#page_nav_area");
		}
				...
				success:function(result){
					...
					to_page(totalRecord);
						...
						if(undefined != result.extend.errorField.name){
							//显示名字错误信息
							show_validate_msg("#empName_add_input","error",result.extend.errorField.name);
						}
					}
				}
			})
		...
		//1、按钮创建之前就绑定了click，所有绑定不上
		//1)、可以在创建按钮的时候绑事件
		//2)、绑定点击.live()
		//jQuery新版没有live 方法 用on替代
